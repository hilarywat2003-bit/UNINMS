...
import { ArrowLeft, Plus, Trash2, Send, Loader2, CheckCircle2, Info } from 'lucide-react';
...
type Form = {
  ...
  coverLetter: string; manuscriptFileUrl: string;
  coAuthors: CoAuthor[];
...
export default function SubmitManuscriptPage() {
  ...
  if (done) return (
    <div className="max-w-lg mx-auto py-20 text-center">
      ...
      <p className="text-stone-500 text-sm mb-8">The editor will review your submission and assign reviewers. You will receive updates in your notifications.</p>
    ...
    <div className="max-w-3xl mx-auto">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div className="card p-6 space-y-4">
          ...
          <div>
            <label className="label">Manuscript file URL <span className="text-stone-400 font-normal">(PDF link from cloud storage)</span></label>
            <input {...register('manuscriptFileUrl')}
              placeholder="https://drive.google.com/… or S3 URL"
              className="input" type="url" />
            <p className="text-xs text-stone-400 mt-1 flex items-center gap-1">
              <Info size={11} /> Upload your file to Google Drive / Dropbox and paste the shareable link here.
            </p>
          </div>
