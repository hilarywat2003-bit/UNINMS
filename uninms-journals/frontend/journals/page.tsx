...
import { BookOpen, Search, Globe, Users, FileText, ArrowUpRight, Filter } from 'lucide-react';
...
export default function JournalsPage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['journals', search, page],
    queryFn: () => api.get('/journals', { params: { search: search||undefined, page, limit: 18 } }).then(r => r.data.data),
  });
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="rounded-2xl p-8 mb-8 text-white relative overflow-hidden"
        ...
        <div className="relative max-w-2xl">
          ...
          <p className="text-white/70 mb-6">Peer-reviewed academic journals hosted by Nigerian universities. Submit your manuscript, review papers, and access published research.</p>
