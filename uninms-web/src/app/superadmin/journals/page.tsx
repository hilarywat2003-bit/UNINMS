...
import {
  ...
  TrendingUp, CreditCard, Ban, X, Eye,
} from 'lucide-react';
            ...
            {(pending as any[]).map((j: any) => {
              ...
              return (
                <div key={j.id} className={clsx('card p-5', hasPaid && 'border-l-4 border-l-blue-400')}>
                  ...
                  {j.scope && (
                    <p className="text-xs text-stone-500 mt-3 line-clamp-2 leading-relaxed">{j.scope}</p>
                  )}
